...
class PlaidAuthenticator extends Component {
  render() {
    ...
    let uri = `https://cdn.plaid.com/link/v2/stable/link.html?key=d287f06585ad643733acd46aac9c43&apiVersion=v2&env=sandbox&product=auth,transactions&clientName=${clientName}&isWebView=true&isMobile=true&selectAccount=false&countryCodes=GB`
